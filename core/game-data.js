  ...
  const miniGames = [
    {
      ...
      description: "Launch an English-heavy Gocean study run with MCQ, free-text, quiz, and matching practice.",
      formatNote: "Weighted Gocean mix: quiz 50%, free-text 25%, MCQ 20%, match pairs 5%.",
    ...
    },
    {
      ...
      description: "Practice hard Year 6 maths and reasoning through a weighted Gocean challenge mix.",
    ...
    },
    {
      ...
      description: "Push through harder science and reasoning prompts that bank resources and expose weak topics for perfection quests.",
      formatNote: "Performance can unlock personalised improvement quests, and only finals award diplomas.",
      difficultyLabel: "Expert Leaning",
      reward: { ink: 2, revisionTokens: 1 },
    },
    {
      id: "match-pairs",
      label: "Atlas Reef Humanities",
      roomId: "curiosity-arcade",
      subjectFocus: "History & Geography",
      artAsset: "side-games/match-pairs-mini-game.png",
      description: "Mix history, geography, and vocabulary practice into the same weighted Year 6 Gocean loop.",
      formatNote: "Matching rounds are rarer, but they still feed resources and can trigger follow-up perfection quests.",
