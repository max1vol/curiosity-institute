...
export const ROOM_BLUEPRINTS = [
  ...
  {
    id: "coin-mint-lab",
    label: "Maths Reasoning Lab",
    artAsset: "developed-views/coin-mint-demo-day2.png",
    previewAsset: "side-games/estimation-mini-game.png",
    blurb: "A Year 6 maths room for hard reasoning prompts, quick working, and diploma-building practice.",
    cost: 46,
    diplomaRequirement: 3,
    startUnlocked: false,
  ...
  },
  {
    ...
    blurb: "A reading and writing station for hard Year 6 curriculum prompts, model answers, and rewrite tasks.",
    cost: 28,
    diplomaRequirement: 1,
    startUnlocked: false,
    requiredRoomIds: ["foyer"],
  ...
  },
  {
    ...
    blurb: "A lab-style room for challenging science and reasoning quizzes that award diplomas on success.",
    cost: 52,
  ...
  {
    id: "curiosity-arcade",
    label: "Humanities Match Hall",
    artAsset: "detail-sheets/museum-style-details.png",
    previewAsset: "side-games/match-pairs-mini-game.png",
    blurb: "A Year 6 history and geography room that mixes matching practice with tougher quiz rounds.",
    cost: 54,
    diplomaRequirement: 4,
    startUnlocked: false,
